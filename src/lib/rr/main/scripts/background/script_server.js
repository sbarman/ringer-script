...
var ScriptServer = (function ScriptServerClosure() {
  ...
  ScriptServer.prototype = {
    ...
    processBenchmarkRun: function _processBenchmarkRun(item, callback) {
      ...
      var notes = item.notes;
      var log = item.log;
      var timeouts = item.timeouts;
      var triggerTimeouts = item.triggerTimeouts;
      ...
      if (timeouts)
        postMsg['timeouts'] = JSON.stringify(timeouts);

      if (triggerTimeouts)
        postMsg['trigger_timeouts'] = JSON.stringify(triggerTimeouts);
